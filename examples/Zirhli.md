...
![Level](<https://img.shields.io/badge/Level-17-blue?style=flat>) ![CP](<https://img.shields.io/badge/CP-273-purple?style=flat>) ![Class](<https://img.shields.io/badge/Class-Dragonknight-green?style=flat>) ![ESO+](<https://img.shields.io/badge/ESO+-Active-gold?style=flat>)
...
| **🐴 Riding Skills** | 🐴 60/60 / 💪 19/60 / 🎒 60/60 |
...
| **🪨 Mundus Stone** | [The Lady](https://en.uesp.net/wiki/Online:The_Lady_(Mundus_Stone)) |
...
| **Category** | **Stat** | **Value** |
| --- | --- | ---: |
| 💚 **Resources** | Health | 32,271 |
|  | Magicka | 17,757 |
|  | Stamina | 20,385 |
| ⚔️ **Offensive** | Weapon Power | 2,122 |
|  | Spell Power | 2,122 |
...
| **Category** | **Stat** | **Value** |
| --- | --- | ---: |
| 🛡️ **Defensive** | Physical Resist | 20,146 (95.9%) |
|  | Spell Resist | 20,146 (95.9%) |
| ♻️ **Recovery** | Health | 622 |
|  | Magicka | 1,367 |
|  | Stamina | 1,367 |
...
| **Ability** | **Cost/Value** |
|:---|---:|
| ⚔️ **Light Attack** | 2,937 dmg |
| ⚔️ **Heavy Attack** | 5,874 dmg |
| ⚔️ **Bash** | 574 cost, 4,293 dmg |
| 🛡️ **Block** | 1,414 cost, 50% mit, 40% spd |
| 🔓 **Break Free** | 5,400 cost |
| 🏃 **Dodge Roll** | 4,712 cost |
...
| **1** | **2** | **3** | **4** | **5** |
| :---: | :---: | :---: | :---: | :---: |
| [Spiked Armor](https://en.uesp.net/wiki/Online:Spiked_Armor) | [Molten Weapons](https://en.uesp.net/wiki/Online:Molten_Weapons) | [Shield Charge](https://en.uesp.net/wiki/Online:Shield_Charge) | [Fiery Breath](https://en.uesp.net/wiki/Online:Fiery_Breath) | [Soul Trap](https://en.uesp.net/wiki/Online:Soul_Trap) |

### 🔮 🔮 🔮 Back Bar (Backup)

| **1** | **2** | **3** | **4** | **5** |
| :---: | :---: | :---: | :---: | :---: |
| [Spiked Armor](https://en.uesp.net/wiki/Online:Spiked_Armor) | [Molten Weapons](https://en.uesp.net/wiki/Online:Molten_Weapons) | [Soul Trap](https://en.uesp.net/wiki/Online:Soul_Trap) | [Focused Aim](https://en.uesp.net/wiki/Online:Focused_Aim) | [Fiery Breath](https://en.uesp.net/wiki/Online:Fiery_Breath) |
...
| **Set** | **Progress** |
| --- | --- |
| 🔴 **[Grace of Gloom Set](https://en.uesp.net/wiki/Online:Grace_of_Gloom_Set)** | `2/5` ████░░░░░░ 40% |
...
| --- | --- | --- | --- | --- | --- | --- |
| ⛑️ **Head** | iron helm of Stamina | - | ⚡ Fine | Reinforced | Heavy | Maximum Stamina Enchantment |
| 💎 **Neck** | pewter necklace | - | ⚡ Fine | Robust | None | - |
| 🛡️ **Chest** | iron cuirass of Stamina | - | 🔮 Superior | Reinforced | Heavy | Maximum Stamina Enchantment |
| 👑 **Shoulders** | iron pauldron of Health | - | ⚡ Fine | Reinforced | Heavy | Maximum Health Enchantment |
| ⚔️ **Main Hand** | Vanus's Sword | [Wisdom of Vanus Set](https://en.uesp.net/wiki/Online:Wisdom_of_Vanus_Set) | 🔮 Superior | Decisive | None | Absorb Magicka Enchantment |
| 🛡️ **Off Hand** | Prophet's Shield | [Prophet's Set](https://en.uesp.net/wiki/Online:Prophet's_Set) | 🔮 Superior | Training | None | Maximum Health Enchantment |
| ⚡ **Waist** | Gloom-Graced Girdle | [Grace of Gloom Set](https://en.uesp.net/wiki/Online:Grace_of_Gloom_Set) | ⚡ Fine | Divines | Heavy | Maximum Health Enchantment |
| 👖 **Legs** | iron greaves of Health | - | 🔮 Superior | Reinforced | Heavy | Maximum Health Enchantment |
| 👟 **Feet** | Gloom-Graced Sabatons | [Grace of Gloom Set](https://en.uesp.net/wiki/Online:Grace_of_Gloom_Set) | 🔮 Superior | Well-fitted | Heavy | Maximum Health Enchantment |
| 💍 **Ring 1** | pewter ring of Reduce Spell Cost | - | ⚡ Fine | Healthy | None | Reduce Spell Cost Enchantment |
| 💍 **Ring 2** | pewter ring of Reduce Spell Cost | - | 🔮 Superior | Healthy | None | Reduce Spell Cost Enchantment |
| ✋ **Hands** | iron gauntlets of Stamina | - | ⚡ Fine | Reinforced | Heavy | Maximum Stamina Enchantment |
| 🔮 **Backup Main Hand** | oak bow of Frost | - | 🔮 Superior | Powered | None | Frozen Weapon Enchantment |
...
| 🟡 Crown Experience Scroll | 11 | 🟡 |
| 🟣 Crown Fortifying Meal | 185 | 🟣 |
| 🟡 Crown Lesson: Riding Speed | 1 | 🟡 |
| 🟡 Crown Lethal Poison | 700 | 🟡 |
| 🟣 Crown Refreshing Drink | 46 | 🟣 |
| ⚪ Fan of False-Face | 1 | ⚪ |
| ⚪ Foul Hide | 2 | ⚪ |
| ⚪ Gabrielle's Bottle of Proving | 1 | ⚪ |
| 🔵 Gold Coast Daily Contract Recompense | 1 | 🔵 |
| 🔵 Gold Coast Daily Contract Recompense | 1 | 🔵 |
| 🔵 Grahtwood Treasure Map IV | 1 | 🔵 |
| 🟡 Grand Gold Coast Experience Scroll | 2 | 🟡 |
...
| ⚪ Lantern of Lies | 1 | ⚪ |
| ⚪ Lockpick | 120 | ⚪ |
| ⚪ Mirror of Fatal Premonition | 1 | ⚪ |
| 🟢 Nel's Hidden Loves | 1 | 🟢 |
| ⚪ oak inferno staff | 1 | ⚪ |
| ⚪ oak shield | 1 | ⚪ |
| ⚪ Pillow of Sweet Dreams | 1 | ⚪ |
...
| ⚪ steel dagger | 1 | ⚪ |
| ⚪ steel greaves | 1 | ⚪ |
| 🔵 The Rift Treasure Map IV | <!-- Chunk 2 (20416 bytes before padding) -->
...
<details>
<summary><strong>Crafting Bag Items</strong> (340 unique items)</summary>
...
<details>
<summary><strong>⚒️ Crafting (1170/3400 pts)</strong></summary>
...
| **Pacrooti's Hirelings** | Member | 500 | [Aldmeri Dominion](https://en.uesp.net/wiki/Online:Aldmeri_Dominion) |
| **Song of Sun and Moon** | Member | 491 | [Ebonheart Pact](https://en.uesp.net/wiki/Online:Ebonheart_Pact) |

---

<div align="center">

![Format](<https://img.shields.io/badge/Format-MARKDOWN-blue?style=flat>) ![Size](<https://img.shields.io/badge/Size-66,167%20chars-purple?style=flat>)

**⚔️ CharacterMarkdown by @solaegis**

<sub>Generated on 01/24/2026 • Version: 2.2.5-1-gc8006c8</sub>

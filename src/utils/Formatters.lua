...
local function FormatSettingsForExport(settings)
    ...
    local export = {
        ...
        core = {
            ...
            customNotes = actualSettings.customNotes or "",
        },
        ...
        extended = {
            ...
            includeAchievementsDetailed = actualSettings.includeAchievementsDetailed == true,
...
local function YAMLToTable(yamlStr)
    ...
    local function parseValue(str)
        ...
        if str == "null" or str == "nil" then return nil end

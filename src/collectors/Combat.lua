...
local function CollectCombatStatsData()
    ...
    stats.weaponCritChance = stats.weaponCritRating > 0 and 
        math_floor((stats.weaponCritRating / 219) * 10) / 10 or 0
    stats.spellCritChance = stats.spellCritRating > 0 and 
        math_floor((stats.spellCritRating / 219) * 10) / 10 or 0
    ...
    stats.physicalMitigation = stats.physicalResist > 0 and 
        math_floor((stats.physicalResist / (stats.physicalResist + resistDivisor)) * 1000) / 10 or 0
    stats.spellMitigation = stats.spellResist > 0 and 
        math_floor((stats.spellResist / (stats.spellResist + resistDivisor)) * 1000) / 10 or 0

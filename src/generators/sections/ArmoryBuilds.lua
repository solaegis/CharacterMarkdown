    ...
    for i, build in ipairs(armory.builds) do
        ...
        if build.equipment and #build.equipment > 0 then
            ...
            for _, item in ipairs(build.equipment) do
                ...
                if item.slot == 0 then slotName = "Head"
                elseif item.slot == 1 then slotName = "Neck"
                elseif item.slot == 2 then slotName = "Chest"
                elseif item.slot == 3 then slotName = "Shoulders"
                elseif item.slot == 4 then slotName = "Main Hand"
                elseif item.slot == 5 then slotName = "Off Hand"
                elseif item.slot == 6 then slotName = "Waist"
                elseif item.slot == 7 then slotName = "Legs"
                elseif item.slot == 8 then slotName = "Feet"
                elseif item.slot == 11 then slotName = "Ring 1"
                elseif item.slot == 12 then slotName = "Ring 2"
                elseif item.slot == 13 then slotName = "Hands"
                elseif item.slot == 20 then slotName = "Backup Main"
                elseif item.slot == 21 then slotName = "Backup Off"
                end

#!/usr/bin/env python3
"""
Trim unnecessary newlines in markdown files without breaking markdown syntax.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Trim unnecessary newlines in markdown files'
    )
    parser.add_argument(
        'files',
        nargs='+',
